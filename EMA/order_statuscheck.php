...
if(mysql_num_rows($queryreject)>0){
  while($emailrowsreject=mysql_fetch_array($queryreject)){
    $senderemailreject=$emailrowsreject[1];
     $ordersenderreject=mysql_query(" select user.fristname,user.lastname  from user  where  user.email='$senderemailreject'") or die(' reject order sender table selection query error');
          ...
          <div class="row">
            <div class="col-md-3" align="center">
               ...
               <?php
                ...
                $imgreject = mysql_query("SELECT `name` FROM `profile_picture` WHERE email='$senderemailreject' and `for`='profile'")or die('organizar picture selection  query error');
                if(mysql_num_rows($imgreject)>0){
                                 $orgimgreject=mysql_fetch_array($imgreject)
                ?>
                <img src="profile_pictures/<?php echo $orgimgreject[0];?>" class="img-rounded">
                <?php
            }
            else{
              ?>
...
if(mysql_num_rows($queryworkstream)>0){
  while($emailrowsworkstream=mysql_fetch_array($queryworkstream)){
    $senderemailworkstream=$emailrowsworkstream[1];
     $ordersenderworkstream=mysql_query(" select user.fristname,user.lastname  from user  where  user.email='$senderemailworkstream'") or die(' workstream order sender table selection query error');
          ...
          <div class="row">
            <div class="col-md-3" align="center">
               ...
               <?php
                ...
                $imgworkstream = mysql_query("SELECT `name` FROM `profile_picture` WHERE email='$senderemailworkstream' and `for`='profile'")or die('organizar picture selection  query error');
                if(mysql_num_rows($imgworkstream)>0){
                                 $orgimgworkstream=mysql_fetch_array($imgworkstream)
                ?>
                <img src="profile_pictures/<?php echo $orgimgworkstream[0];?>" class="img-rounded">
                <?php
            }
            else{
              ?>
...
if(mysql_num_rows($querycompleted)>0){
  while($emailrowscompleted=mysql_fetch_array($querycompleted)){
    $senderemailcompleted=$emailrowscompleted[1];
     $ordersendercompleted=mysql_query(" select user.fristname,user.lastname  from user  where  user.email='$senderemailcompleted'") or die(' workstream order sender table selection query error');
          ...
          <div class="row">
            <div class="col-md-3" align="center">
               ...
               <?php
                ...
                $imgcompleted = mysql_query("SELECT `name` FROM `profile_picture` WHERE email='$senderemailcompleted' and `for`='profile'")or die('organizar picture selection  query error');
                if(mysql_num_rows($imgcompleted)>0){
                                 $orgimgcompleted=mysql_fetch_array($imgcompleted)
                ?>
                <img src="profile_pictures/<?php echo $orgimgcompleted[0];?>" class="img-rounded">
                <?php
            }
            else{
              ?>
