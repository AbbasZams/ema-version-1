...
if($chargingtype=="paid"){
	$dd=mysql_query("INSERT INTO `paid_event_detail`( `requirements`,`orgDescription`, `ticketnumbers`, `ticketprice`) VALUES('$requirements','$orgDescription','$ticketnumbers','$ticketprice')") or die('paid eventtable insertion query error');
}
if(!$q && $d && $dd)
{
