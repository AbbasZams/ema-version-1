				...
				<!-- Main -->
					<div id="main">
						...
						<!-- One -->
							...
							<div class="row">
								<div class="col-md-12">
								<h4 align="center"  style="color:#286E88;  font-family: 'Kaushan Script', cursive;">Update event here..</h4>
									<br>
									<br>
									<?php
									$id=$_GET['id'];
...
<div class="form-group">
  <label class="col-md-4 control-label fo" for="textinput" style="color:#286E88; font-family: 'Kaushan Script', cursive !important;">Title</label>  
  <div class="col-md-4">
...
<!-- Select Basic -->
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic"  style="color:#286E88; font-family: 'Kaushan Script', cursive !important;">Category </label>
  <div class="col-md-4">
 ...
 <!-- Select country -->
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic"  style="color:#286E88; font-family: 'Kaushan Script', cursive; ">Select Contry</label>
  <div class="col-md-4">
...
<!-- Select city -->
<div class="form-group">
  <label class="col-md-4 control-label" for="selectbasic"  style="color:#286E88; font-family: 'Kaushan Script', cursive; ">Select City</label>
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"  style="color:#286E88; font-family: 'Kaushan Script', cursive !important;">Address</label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"  style="color:#286E88; font-family: 'Kaushan Script', cursive !important;">Starting date</label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"  style="color:#286E88; font-family: 'Kaushan Script', cursive !important;">Ending date</label>  
  <div class="col-md-4">
...
<!-- Text input-->
<div class="form-group">
  <label class="col-md-4 control-label" for="textinput"  style="color:#286E88; font-family: 'Kaushan Script', cursive !important;">Time</label>  
  <div class="col-md-2">
...
<!-- Textarea -->
<div class="form-group">
  <label class="col-md-4 control-label" for="textarea"  style="color:#286E88; font-family: 'Kaushan Script', cursive !important;">Description</label>
  <div class="col-md-4">                     
