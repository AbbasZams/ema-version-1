						...
						<div class="row" align="center">
									...
									<br>
										...
										if($phase=='new' or $phase=='read'){
											...
											You have to finish the order 1 Day before Events start 
										</div>
										<div class="col-md-2">
										...
										<div class="col-md-2">
											<a href="order_state.php?senderemail=<?php echo $senderemail;?>&&id=<?php echo $id;?>&&orderno=<?php echo $orderno;?>&&state=reject" onclick="return window.confirm('are you sure to reject this order')"><button class="btn btn-danger acc-rej">Deny</button></a>
										</div>
										<div class="col-md-1">
									...
									<?php
										if($phase=='workstream'){
											...
											<div class="row">
												<div class="col-md-12">
													<h3 align="center" style="color: #307C94;">Workstream over after</h3>
												</div>
...
if(isset($_POST['paymentrecive'])){
	...
	exit();
		...
		$payrecive=mysql_query("UPDATE `order_payment` SET `reciver_accoun_no`='$accountnumber' where `sender_email`='$senderemail' and `reciver_email`='$_SESSION[email]' and `order_no`='$orderno'and `evant_id`='$id'" )or die('updation query error');
		if($payrecive){
