...
$q=mysql_query("INSERT INTO `ema`.`organizer` (`organizer_email`, `companyname`, `about`,`special`, `country`, `city`, `address`) VALUES ('$_SESSION[email]', '$companyname', '$about','$special', '$country', '$city', '$address')")or die('organizer table insertion query error') ;
if(!$q)
{
