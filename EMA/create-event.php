...
<div class="row">
  ...
  <div class="col-md-3">
    <button id="singlebutton" style="float: right; padding: 10px; letter-spacing: 2px; transition: all .5s ease-in-out;" type="submit" name="create_event" class="btn btn-success">Go Live</button>
  </div>
</div>
