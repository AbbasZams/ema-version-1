			...
			<section id="header">
				<header>
                            ...
                            mysql_select_db("ema",$con);
								$profilepicture = mysql_query("SELECT `name` FROM `profile_picture` WHERE email='$individulemail' and `for`='profile'")or die('profile picture selection  query error');
					...
					<?php
										...
										?>
										<div><span class="image avatar new-pro"><img src="images/ABB.png" alt="" /></span></div> 
									<?php
									}
									$username = mysql_query("SELECT `fristname`,`lastname` FROM `user` WHERE email='$individulemail' ")or die('user selection  query error');
							...
							?>
								<div class="well">
									<div class="row" style=" color: black !important">
										<div class="col-sm-3" align="center" style="border-right: 2px solid gray;">
											<div style=" width: 120px; height: 120px;">
										 		<?php
										 			$profilephoto = mysql_query("SELECT `name` FROM `profile_picture` WHERE email='$individulemail' and `for`='profile'")or die('profile picture selection  query error');
												...
												<span class="image avatar"><img src="images/ABB.png" alt="" /></span>
									...
									?>
												...
												<img src="profile_pictures/<?php echo $reviewerpic[0];?>" class="img-responsive img-rounded" style="width: 80px; height: 60px;">
												<?php
											}else
											{
											?>
...
<?php
	  ...
	  <center>There is no any upcoming event of this person</center>
	  </font>
	  </p>
	  <?php
  }
								...
								<div class="well" style=" color: black !important">
									<div class="row" >
										...
										<div class="col-sm-3" align="center" style="border-right: 2px dashed gray">
										 <?php
										 $yourphoto = mysql_query("SELECT `name` FROM `profile_picture` WHERE email='$individulemail' and `for`='profile'")or die('logo selection  query error');
