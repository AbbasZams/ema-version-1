...
<!--................................... End of header div.............................. -->						</section>
	  ...
	  if(mysql_num_rows($picture)>0){
		  $reviewerphoto=mysql_fetch_array($picture)
		  ?>
											<div style="width: 140px; height: 120px;   float: right;">
												<img src="profile_pictures/<?php echo $reviewerphoto[0];?>" class="img-responsive img-rounded">
											</div>
											<?php
										}else{
											?>
										...
										<div class="col-md-9">
											...
											<div class="row">
												<div class="col-sm-9">
												<?php
												$user=mysql_query("SELECT `fristname`,`lastname` FROM `user` WHERE email='$email'") or die(' revier name selection querr error');
