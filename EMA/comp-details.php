...
?>
								...
								<div class="col-md-4" align="center">
									<div class="row">
										<div class="col-sm-12">
											<?php
											$companylogo = mysql_query("SELECT `name` FROM `profile_picture` WHERE email='$_SESSION[email]' and `for`='logo'")or die('logo selection  query error');
											...
											<br>
											<div>
											<a href="upload_company_logo.php">	<button class="btn btn-success" align="center"> Update Logo </button></a>	&nbsp; <a href="receiveorder.php"><button class="btn btn-info" style="width: 25px;" title="Orders"> <span class="fa fa-bell"></span> </button>
											<?php
					...
					if($note[0]>0){
						...
						<!-- Two -->
							...
							<br>
								...
								<button class="btn btn-success" name="add" type="submit" title="Add package" style="margin-left: 760px; width: 200px; letter-spacing: 2px">+ ADD</button>
								</form>
								<br>
